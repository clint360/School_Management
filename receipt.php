...
<div class="container-fluid">
	<p class="text-center"><b>MASTERS BILINGUAL COLLEGE - Fee Payment Reciept</b></p>
	<hr>
	<div class="flex">
		<div class="w-50">
			<p>EF. No: <b><?php echo $ef_no ?></b></p>
			<p>Student: <b><?php echo ucwords($sname) ?></b></p>
			<p>Level/Class: <b><?php echo $class ?></b></p>
		</div>
		<?php if($_GET['pid'] > 0): ?>
		<div class="w-50">
			<p>Payment Date: <b><?php echo isset($pay_arr[$_GET['pid']]) ? date("M d,Y",strtotime($pay_arr[$_GET['pid']]['date_created'])): '' ?></b></p>
			<p>Paid Amount: <b><?php echo isset($pay_arr[$_GET['pid']]) ? number_format($pay_arr[$_GET['pid']]['amount'],2): '' ?>FCFA</b></p>
			...
			<td width="50%">
				...
				<table width="100%">
					<tr>
						...
						<td width="50%" class='text-right'>Amount(FCFA)</td>
					</tr>
					<?php 
